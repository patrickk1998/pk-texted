...
# 26 "/usr/include/aarch64-linux-gnu/sys/types.h" 2 3 4
...
int create_line_list(char *filename, struct line_list *list)
{
 ...
 while((rdb = read(fd, read_buffer, 256))){
...
"pos >= 0 && pos <= list->lines"
# 103 "texted.c" 3 4
, "texted.c", 103, __extension__ __PRETTY_FUNCTION__); }))
# 103 "texted.c"
                                      ;
...
"callback"
# 137 "texted.c" 3 4
, "texted.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "texted.c"
                ;
